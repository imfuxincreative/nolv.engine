...
function Layer8() {
  ...
  return (
    <div>
      <h6
        ref={refs.intro}
        className="absolute top-[78vw] z-[70] bg-white pl-2 pb-1 right-[30vw]"
      ...
      <h6
        ref={refs.founder}
        className="absolute top-[95vw] z-[70] bg-white pl-2 pb-1 left-[10vw]"
        style={{ transition: 'transform 0.1s ease-out' }}
      >
        Founded by meeza™
      </h6>
      <h6
        ref={refs.logo}
        className="absolute top-[100vw] z-[70] bg-white pl-2 pb-1 right-[20vw]"
        style={{ transition: 'transform 0.1s ease-out' }}
      >
        logo.png
      </h6>
