...
useEffect(() => {
  ...
  return (
    <div className="fixed z-[999]">
      ...
      <div onMouseLeave={()=> setCursorAnimation('onhome-animation')} onMouseEnter={()=> setCursorAnimation('menubutton-animation')} className=" flex items-center justify-center gap-10 lg:gap-20 w-[270px] lg:w-[370px] h-[35px] lg:h-[37px] min-h-[30px] max-h-[45px] bg-black/20  backdrop-blur-xl rounded-full overflow-hidden z-[999]">
