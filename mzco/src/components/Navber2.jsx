...
const handleResource= ()=>{
  navigate('/resources')
  menuSliderRef.current.style.transform = 'translate(195px)'
}
  return (
    ...
    <button onClick={()=> navigate('/infiniteGrid')} className='lg:h-[34px] h-[7vw] w-[22vw] px-2 lg:w-[100px] rounded-full fixed z-[999] right-10 top-10 text-white bg-black'>What if ?</button>
    </div>
  )
}
